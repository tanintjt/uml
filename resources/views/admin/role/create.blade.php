...
@section('content')
    {!! Form::open(array('url' => Request::segment(1).'/role/store', 'class' => 'form-horizontal', 'name' => 'admin-form', 'id' => 'admin-form')) !!}
        ...
        <div class="box-body">
            ...
            <div class="col-xs-6">
                <div class="form-group{{ $errors->has('permission_id') ? ' has-error' : '' }}">
                    ...
                    <div class="col-xs-8">
                        {!! Form::select('permission_id[]', $permissions, old('permission_id'), ['class' => 'form-control', 'id' => 'permission_id', 'multiple']) !!}
