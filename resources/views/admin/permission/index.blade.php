...
@section('content')
    {!! Form::open(array('url' => Request::segment(1).'/permission', 'method' => 'POST', 'class' => 'form-inline', 'name' => 'admin-form', 'id' => 'admin-form')) !!}
        ...
        <div class="box-header with-border">
            <div class="input-group">
                ...
                <span class="input-group-btn">
                    ...
                    <a href="{!! url(Request::segment(1).'/permission/create')!!}" class="btn btn-sm btn-primary"><span class="glyphicon glyphicon-plus-sign"></span> New</a>
                </span>
            </div>
                ...
                <table class="table table-bordered">
                    ...
                    @foreach ($rows as $row)
                        <tr>
                            ...
                            <td>
                                <a href="{!! url(Request::segment(1).'/permission/'.$row->id) !!}" class="btn btn-xs btn-success"><span class="glyphicon glyphicon-eye-open"></span></a>
                                <a href="{!! url(Request::segment(1).'/permission/'.$row->id.'/edit') !!}" class="btn btn-xs btn-primary"><span class="glyphicon glyphicon-edit"></span></a>
