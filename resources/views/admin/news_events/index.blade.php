...
@section('content')
    {!! Form::open(array('url' => Request::segment(1).'/news-events', 'method' => 'POST', 'class' => 'form-inline', 'name' => 'admin-form', 'id' => 'admin-form')) !!}
        ...
        <div class="box-header with-border">
            <div class="input-group">
                ...
                <span class="input-group-btn">
                    ...
                    <a href="{!! url(Request::segment(1).'/news-events/create')!!}" class="btn btn-sm btn-primary"><span class="glyphicon glyphicon-plus-sign"></span> New</a>
                </span>
            </div>
                    ...
                    @foreach ($rows as $row)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{!! route('news-events-delete',$row->id) !!}" class="btn btn-xs btn-danger" title="Delete " user="button" data-toggle="modal" data-target="#confirmDelete" data-title="Delete" data-message="Are you sure you want to delete ?"><span class="glyphicon glyphicon-trash"></span></a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
