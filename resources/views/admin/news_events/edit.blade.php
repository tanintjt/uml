...
@section('content')
    ...
    {!! Form::model($row,['method' => 'PUT','url' => Request::segment(1).'/news-events/'.$row->id,'class' => 'form-horizontal', 'id' => 'admin-form','files'=>'true' ]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="col-xs-7">
                ...
                <div class="form-group{{ $errors->has('start_date') ? ' has-error' : '' }}">
                    ...
                    <div class="col-xs-9">
                        {!! Form::text('start_date',  old('start_date',date('Y-m-d', strtotime($row->start_date))),['class' => 'form-control datepicker', 'id' => 'start_date', 'placeholder' => 'start date']) !!}
            ...
            <div class="col-xs-5">
                ...
                <div class="form-group{{ $errors->has('end_date') ? ' has-error' : '' }}">
                    ...
                    <div class="col-xs-9">
                        {!! Form::text('end_date',  old('end_date',date('Y-m-d', strtotime($row->end_date))),['class' => 'form-control datepicker', 'id' => 'end_date', 'placeholder' => 'end date']) !!}
                ...
                <div class="form-group">
                    <div class="col-xs-offset-3 col-xs-9">
                        ...
                        <a href="{!! url('admin/news-events') !!}" class="btn btn-sm btn-danger"><span class="glyphicon glyphicon-repeat"></span> Cancel</a>
                    </div>
                </div>
