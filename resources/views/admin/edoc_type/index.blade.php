...
@section('content')
    {!! Form::open(array('url' => Request::segment(1).'/e-doc-type', 'method' => 'POST', 'class' => 'form-inline', 'name' => 'admin-form', 'id' => 'admin-form')) !!}
        ...
        <div class="box-header with-border">
            <div class="input-group">
                ...
                <span class="input-group-btn">
                    ...
                    <a href="{!! url(Request::segment(1).'/e-doc-type/create')!!}" class="btn btn-sm btn-primary"><span class="glyphicon glyphicon-plus-sign"></span> New</a>
                </span>
            </div>
                ...
                <table class="table table-bordered">
                    ...
                    @foreach ($rows as $row)
                        <tr>
                            ...
                            <td>
                                <a href="{!! url(Request::segment(1).'/e-doc-type/'.$row->id) !!}" class="btn btn-xs btn-success"><span class="glyphicon glyphicon-eye-open"></span></a>
                                <a href="{!! url(Request::segment(1).'/e-doc-type/'.$row->id.'/edit') !!}" class="btn btn-xs btn-primary"><span class="glyphicon glyphicon-edit"></span></a>
                                ...
                                <a href="{!! route('e-doc-type-delete',$row->id) !!}" class="btn btn-xs btn-danger" title="Delete {!! $row->display_name !!}" user="button" data-toggle="modal" data-target="#confirmDelete" data-title="Delete {!!  $row->display_name !!}" data-message="Are you sure you want to delete {!!  $row->display_name !!} ?"><span class="glyphicon glyphicon-trash"></span></a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
