...
@section('content')
    {!! Form::open(array('route' => 'admin.user.store', 'class' => 'form-horizontal', 'name' => 'admin-form', 'id' => 'admin-form')) !!}
        ...
        <div class="panel-body">
            ...
            <div class="col-xs-6">
                <div class="form-group{{ $errors->has('role_id') ? ' has-error' : '' }}">
                    ...
                    <div class="col-xs-6">
                        {!! Form::select('role_id[]', $roles, old('role_id'), ['class' => 'form-control', 'id' => 'role_id', 'multiple']) !!}
                ...
                <div class="form-group{{ $errors->has('dealer_id') ? ' has-error' : '' }}">
                    ...
                    <div class="col-xs-9">
                        {!! Form::select('dealer_id', $dealers, old('dealer_id'), ['class' => 'form-control', 'id' => 'dealer_id']) !!}
