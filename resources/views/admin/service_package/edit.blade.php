        ...
        <div class="box-body">
            <div class="col-xs-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-3">
                        {!! Form::textarea('details', old('details',$row->details), ['class' => 'form-control', 'id' => 'details', 'placeholder' => 'Details', 'rows' => 3]) !!}
                    </div>
                </div>
                <div class="form-group{{ $errors->has('package_rate') ? ' has-error' : '' }}">
                    {!! Form::label('package_rate', 'Package Rate :', ['class' => 'col-xs-3 control-label']) !!}
                    <div class="col-xs-3">
                        {!! Form::text('package_rate', old('package_rate',$row->package_rate), ['class' => 'form-control', 'id' => 'package_rate', 'placeholder' => 'package rate']) !!}
