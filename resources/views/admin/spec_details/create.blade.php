        ...
        <div class="panel-body">
            ...
            <div class="col-xs-5">
                ...
                <div class="form-group{{ $errors->has('cat_id') ? ' has-error' : '' }}">
                    ...
                    <div class="col-xs-9">
                        {!! Form::select('cat_id', $spec_category, old('cat_id'), ['class' => 'form-control', 'id' => 'cat_id']) !!}
            ...
            <div class="col-xs-7">
                ...
                <div class="form-group{{ $errors->has('spec_value') ? ' has-error' : '' }}">
                    ...
                    <div class="col-xs-9">
                        {!! Form::text('spec_value', old('spec_value'), ['class' => 'form-control', 'id' => 'spec_value', 'placeholder' => 'specification value']) !!}
