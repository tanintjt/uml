...
@section('content')
    {!! Form::open(array('url' => Request::segment(1).'/employee/'.$row->id, 'class' => 'form-horizontal', 'name' => 'admin-form', 'id' => 'admin-form', 'method' => 'get')) !!}
        ...
        <div class="box-header with-border">
            <div class="input-group">
                <span class="input-group-btn">
                    ...
                    <a href="{!! url(Request::segment(1).'/employee/'.$row->id.'/edit') !!}" class="btn btn-flat btn-primary pull-right"><i class="fa fa-edit"></i> Edit</a>
                </span>
            </div>
        </div>
