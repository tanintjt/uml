...
@section('content')
    ...
    {!! Form::open(array('url' => Request::segment(1).'/e-documents/store', 'class' => 'form-horizontal', 'name' => 'admin-form', 'id' => 'admin-form','files'=>'true')) !!}
        ...
        <div class="panel-body">
            ...
            <div class="col-xs-6">
                ...
                <div class="form-group{{ $errors->has('issue_date') ? ' has-error' : '' }}">
                    ...
                    <div class="col-xs-9">
                        {!! Form::text('issue_date',  old('issue_date'),['class' => 'form-control datepicker', 'id' => 'issue_date', 'placeholder' => 'issue date']) !!}
            ...
            <div class="col-xs-6">
                ...
                <div class="form-group{{ $errors->has('expiry_date') ? ' has-error' : '' }}">
                    ...
                    <div class="col-xs-9">
                        {!! Form::text('expiry_date',  old('expiry_date'),['class' => 'form-control datepicker', 'id' => 'expiry_date', 'placeholder' => 'expiry date']) !!}
